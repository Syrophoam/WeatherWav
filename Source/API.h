...
//    currentTime = "2024-12-10T06:15:00Z"; <- if current time not working lol FIX IT
    currentTime = std::format("{:%FT%H:%M:00Z}", now); // <- TODO: accomodate for timezone use coordinates
